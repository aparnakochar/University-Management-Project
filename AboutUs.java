...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Chitkara_university_image.jpeg"));
            ...
            JLabel l6 = new JLabel("Developed By : Aparna Kochar");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 1810991940");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : aparna1940.cse18@chitkara.edu.in");
