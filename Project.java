...
public class Project extends JFrame implements ActionListener {
   Project(){
       ...
       setSize(1920,1030);
       ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Chitkara_university_image.jpeg"));
       ...
       ImageIcon icon1=new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
       Image image1=icon1.getImage().getScaledInstance(25,25,Image.SCALE_DEFAULT);
       ImageIcon ap=new ImageIcon(image1);
       m1.setIcon(ap);
       m1.setMnemonic('A');
       ...
       m2.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("second.jpg"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("first.jpg"));
