...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15=new JLabel();
        id15.setBounds(0,0,900,650);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("teacher1.jpg"));
        Image i3 = img.getImage().getScaledInstance(920, 650,Image.SCALE_DEFAULT);
