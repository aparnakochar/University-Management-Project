...
public class UpdateStudent implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update student1 set name='"+t1.getText()+"',father_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',10_marks='"+t8.getText()+"',12_marks='"+t9.getText()+"',adhar='"+t10.getText()+"',course='"+t13.getText()+"',branch='"+t14.getText()+"' where roll_no='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from student1 where roll_no = '"+t12.getText()+"'";
