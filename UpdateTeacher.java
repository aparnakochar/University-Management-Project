...
public class UpdateTeacher implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update teacher set name='"+t1.getText()+"',father_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',10_marks='"+t8.getText()+"',12_marks='"+t9.getText()+"',adhar_number='"+t10.getText()+"', education = '"+t11.getText()+"',id='"+t13.getText()+"',department='"+t14.getText()+"' where id='"+t12.getText()+"'";
