...
public class AddStudent implements ActionListener {
    ...
    public AddStudent(){
        ...
        id15=new JLabel();
        id15.setBounds(0,0,1200,700);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("student1.jpg"));
        ...
        id3= new JLabel("Age");//kya hua  father  do phone inki shift hniiss window ki dimension increase karo
        ...
        id4.setBounds(520,200,200,30);
        id4.setFont(new Font("serif",Font.BOLD,20));
        id4.setForeground(Color.black);
        id15.add(id4);

        t4=new JTextField();
        t4.setBounds(700,200,150,30);
        id15.add(t4);
        ...
        id6.setBounds(520,250,100,30);
        id6.setFont(new Font("serif",Font.BOLD,20));
        id6.setForeground(Color.black);
        id15.add(id6);

        t6=new JTextField();
        t6.setBounds(700,250,150,30);
        id15.add(t6);
    ...
    public void actionPerformed(ActionEvent ae){
                ...
                if(ae.getSource()==b){
                    try{
                        conn cc=new conn();
                        String q="insert into student1 values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"')";
...
//         id15=new JLabel(new ImageIcon(ClassLoader.getSystemResource("fourth.jpg")));
//         add(id15);
//         id15.setLayout(new FlowLayout());
        
//         // id15=new JLabel();
//         // id15.setBounds(0,0,900,700);
//         // id15.setLayout(null);
//         // ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("fourth.jpg"));
//         // Image i3=img.getImage().getScaledInstance(1220, 700, Image.SCALE_DEFAULT);
//         // ImageIcon icc3=new ImageIcon(i3);
//         // id15.setIcon(icc3);
...
//         String course[]={"B.TECH","BBA","MBA","BCom"};
//         c1=new JComboBox(course);
